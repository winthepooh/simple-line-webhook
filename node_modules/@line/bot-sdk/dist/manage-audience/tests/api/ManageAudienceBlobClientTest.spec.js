...
describe("ManageAudienceBlobClient", () => {
    it("addUserIdsToAudienceWithHttpInfo", async () => {
        ...
        const server = (0, node_http_1.createServer)((req, res) => {
            ...
            (0, node_assert_1.equal)(reqUrl.pathname, "/v2/bot/audienceGroup/upload/byFile"
            ...
            (0, node_assert_1.ok)(req.headers["content-type"].startsWith(`multipart/form-data; boundary=`));
