...
exports.convertResponseToReadable = void 0;
...
class HTTPFetchClient {
    constructor(config) {
        ...
        this.defaultHeaders = Object.assign({ "User-Agent": `${pkg.name}/${pkg.version}` }, config.defaultHeaders);
    }
    ...
    async checkResponseStatus(response) {
        ...
        if (!ok) {
            ...
            throw new exceptions_1.HTTPFetchError(message, {
                status,
                statusText,
                headers,
                body,
